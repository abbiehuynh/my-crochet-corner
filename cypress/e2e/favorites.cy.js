// testing suite for favorites component

describe('Favorites Page - renders components', () => {
    beforeEach(() => {
    ...
    it('loads favorites page with correct url', () => {
        cy.url().should('include', '/favorites');
    });

    // tests all components render on favorites page
